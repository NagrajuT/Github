...
class AdminController extends Controller
{
    ...
    public function sendMail($email,$pwd_reset_link)
    {
        ...
        $from = new Email("Smartffic", "no-reply@mail.instaffic.com");
        $to = new Email('Smartffic', "nitishkumar@globussoft.in");
        ...
        $content = new Content("text/html", "<div style='border: 1px solid #F44336; border-radius: 10px; padding:30px; width:60%; margin-left: 20%; margin-right: 20%;' >
                                    <div>
                                        <a href='".env('WEB_URL')."/#support'><img style='width:200px;' src='http://panel.messazon.com/assets/images/hsbcLogo.png' alt='support@smartffic.com'/></a>
                                    </div><hr color='#F44336'>
                                    ...
                                    <hr color='#F44336'>
                                        <font color='#F44336'> Regards <br> Smartffic Team<br> Contact : support@hsbc.com</font>
                                </div>");
