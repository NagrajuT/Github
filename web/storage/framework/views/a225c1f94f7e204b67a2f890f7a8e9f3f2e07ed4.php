                    ...
                    <div class="portlet-body">
                        <?php if($status=='success'): ?>
                            <?php if(isset($data['accountList']) && !empty($data['accountList'])): ?>
                                ...
                                <br>
                                <div class="row">
                                    <?php if($data['logDetails']['log_stat']['totalRecord']>0): ?>
                                                ...
                                                <div class="dashboard-stat2"
                                                    ...
                                                    <div class="display">
                                                        ...
                                                        <span data-counter="counterup" id="followed_count"
                                                              data-value="7800"><?php echo e($data['logDetails']['log_stat']['followed_count']); ?></span>
                                                            </h3>
                                                ...
                                                <div class="dashboard-stat2"
                                                    ...
                                                    <div class="display">
                                                        ...
                                                        <span data-counter="counterup"
                                                              data-value="1349"><?php echo e($data['logDetails']['log_stat']['followers_count']); ?></span>
                                                            </h3>
                                        ...
                                        <div class="programme-log-card container">
                                            <div class="row col-lg-12" id="manualFollowedUsers">
                                                <?php foreach($data['logDetails']['logs'] as $key=>$value): ?>
                                                            ...
                                                            <div class="caption">
                                                                ...
                                                                <span>
                                                                    ...
                                                                    <button class="btn btn-default unfollowUser"
                                                                            ...
                                                                            data-id="<?php echo e($value['manual_follow_id']); ?>">
                                                                        Unfollow
                                                                    </button>
