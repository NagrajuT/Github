...
<div class="body" style="width: 100%;float: left;overflow: hidden;">
        ...
        <div class="container">
            <div class="row">
                <div class="text-center col-8 hero-content">
                    ...
                    <a href="#" class="login  btn-black">Get 5 days free</a><a href="#" class="btn-border play-video">View Demo</a>
                            ...
                            <div id="carousel-example-vertical2" class="carousel vertical slide text-center">
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        ...
                                        <ul>
                                            <li><strong>Instaffic will promote your profile 24/7 and expose it up to
    ...
    <div class="our-benefits-link link2"><a href="#" class="btn btn-success login btn-lg">5 Days Free Trial</a></div>
        ...
        <div class="subscription-container">
            <div class="subscription-wrapper" style="padding-top: 15px;">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="col-md-6">
                <b>Email ID:</b> &nbsp;&nbsp;<a href="mailto:support@instaffic.com">support@instaffic.com</a>
                    </div>
                    <div class="col-md-6">
