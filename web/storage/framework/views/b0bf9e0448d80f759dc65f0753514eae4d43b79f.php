<?php $__env->startSection('headcontent'); ?>
    <?php /*<link rel="stylesheet" href="/assets/user/css/toastr.min.css">*/ ?>
    <?php /*<link rel="stylesheet" type="text/css" href="/assets/user/css/sweetalert.css">*/ ?>
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class=" col-md-8">
                                    ...
                                    <select name="instaUserId" id="instaUserId"
                                            data-value="<?php echo e($data['selectedInstaDetails']['ins_user_id']); ?>"
                                            class="form-control"
                        ...
                        <div class="activity on-off" style="padding-bottom: 50px;">
                            <?php /*DEFAULT PROMOTION START/ STOP*/ ?>
                                ...
                                <div class="panel panel-body"
                                     style="opacity:1; max-height: auto; padding: 9px 15px; overflow: visible; min-height: 55px;">
                                        ...
                                        <span class="uppercase bold start_stop pull-left">Promotion -
                                                    ...
                                                    <?php if($data['activityData']['status'] == '0'): ?>
                                                        ...
                                                        <span style="padding: 10px" class="default_timer"
                                                              data-id="<?php echo e(time()-$data['activityData']['default_promotion_start_time']); ?>">00:00:00:00
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <span style="padding: 10px" class="default_timer"
                                                              data-id=" <?php echo e($data['activityData']['default_promotion_stop_time']-$data['activityData']['default_promotion_start_time']); ?>">
                                                        </span>
                                        ...
                                        <span class=" bold  pull-right">
                                                ...
                                                <div class="col-md-7 onoffswitch1" style="padding:0px;">
                                                    <input type="checkbox" id="emergency_unfollow"
                                                           ...
                                                           <?php if(isset($data['activityData']['default_emergency_unfollow']) && $data['activityData']['default_emergency_unfollow']==1): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="card-base">
                                            <div class="card-icon">
                                                ...
                                                <div class="card-data1 widgetCardData">
                                                    <h2 class="box-title">
                                                        <span id="totalLikedCount"><?php if(isset($data['statData']['default_likes_count'])): ?> <?php echo e($data['statData']['default_likes_count']); ?> <?php endif; ?></span>
                                                    </h2>
                                    ...
                                    <div class="col-md-2 smpadng">
                                        <div class="card-base">
                                            <div class="card-icon">
                                                ...
                                                <div class="card-data1 widgetCardData">
                                                    <h2 class="box-title">
                                                        <span id="totalFollowedCount"><?php if(isset($data['statData']['default_follows_count'])): ?> <?php echo e($data['statData']['default_follows_count']); ?> <?php endif; ?> </span>
                                                    </h2>
                                                    <p class="card-block text-center">
                                    ...
                                    <div class="col-md-2 smpadng">
                                        <div class="card-base">
                                            <div class="card-icon">
                                                ...
                                                <div class="card-data1 widgetCardData">
                                                    <h2 class="box-title">
                                                        <span id="totalUnfollowedCount"><?php if(isset($data['statData']['default_unfollows_count'])): ?> <?php echo e($data['statData']['default_unfollows_count']); ?> <?php endif; ?> </span>
                                                    </h2>
                                                    <p class="card-block text-center">
                                    ...
                                    <div class="col-md-2 smpadng">
                                        <div class="card-base">
                                            <div class="card-icon">
                                                ...
                                                <div class="card-data1 widgetCardData">
                                                    <h2 class="box-title">
                                                        <span id="totalFollowersCount"><?php if(isset($data['statData']['default_followers_count'])): ?> <?php echo e($data['statData']['default_followers_count']); ?> <?php endif; ?> </span>
                                                    </h2>
                                                    <p class="card-block text-center">
...
//            console.log('qwerty');
        ...
        $(function () {
            ...
            <?php if(isset($data['activityData']) && ($data['activityData']['status']==0)): ?>
                    ...
                    if (response.status == 'success') {
                        ...
                        if (currentStatus == 1) {
                            ...
                            appendData = 'Promotion - <a href="javascript:;" title="click to start activity" ' +
                                    'class="btn btn-success default_status_button" style="width: 135px" data-id="1">' +
                                    'Start <i class="fa fa-play"></i> </a> ' +
                                    <?php /*                                        ' <span style="padding: 10px" class="default_timer" data-id=" <?php echo e($data['activityData']['default_promotion_stop_time']-$data['activityData']['default_promotion_start_time']); ?>"></span>' +*/ ?>
                                            ' <span style="padding: 10px" class="default_timer" data-id="' + (response.data.default_promotion_stop_time - response.data.default_promotion_start_time) + '">' +
                                    '' + (sformat(parseInt(response.data.default_promotion_stop_time - response.data.default_promotion_start_time))) + '</span>' +
                                    '<a href="javascript:;" class="btn btn-danger disable" style="width: 135px;">' +
                                    'Stopped<i aria-hidden="true" class="glyphicon glyphicon-stop"></i></a> ';
