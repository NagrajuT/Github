...
@section('pagebodycontent')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="javascript:;">Manage Instagram Account Proxy</a>
                    <i class="fa fa-angle-right"></i>
                </li>
            </ul>
        </div>
        ...
        <div class="page-bar">
            <button class="btn btn-info default yellow-stripe" data-toggle="modal"
                    data-target="#proxyAccountModalFile">
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_show_users">
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        <select name="allocation" class="form-control form-filter input-sm">
                                            <option value="">select...</option>
    ...
    <div class="modal fade" id="proxyAccountModalFile" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:#444D58;">
                    ...
                    <h4 class="modal-title" style="text-align:center;color:white;">Upload Account proxies text file here</h4>

                </div>
                <div class="modal-body">
                    <div class="row" style="margin: 5% 5%;padding: 0px 10px;">
                        <form id="accountProxyFile" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="accountProxyFile">
                                {{--<input type="text" name="qweqe" value="111111" hidden/>--}}
                            </div>
                            <button type="button" value="" name="submit" class="uploadAccountProxy">Upload Account Proxy file</button>
                        </form>
...
//            UIConfirmations.init();
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.ins_prx .arrow').addClass('open');
            $('.ins_prx').addClass('active');
        });
    </script>
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {
                        ...
                        "ajax": {
                            "url": "/show/insta/account/proxies",
//                            "data":{
...
//                            "data": { userTimezone : jstz.determine().name()},// ajax source
    ...
    <script>
        $(document).ready(function () {
        $(document).on('click', '.uploadAccountProxy', function (e) {
            e.preventDefault();
//                var pType = $('#selectType').val();

            var formData = new FormData($("#accountProxyFile")[0]);
            $.ajax({
                url: '/upload/account/proxy/file',
                type: 'post',
                processData: false,
                dataType: 'json',
                contentType: false,
