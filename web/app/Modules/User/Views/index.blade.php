            ...
            <div class="sign-work-belt">
                <div class="signin-wrap">
                    ...
                    <form class="errorModal" id="loginForm" style="height:190px;">
                        <h3 style="color: red">
                            @if(isset($heading)) {{$heading}}@endif
                        </h3>
        ...
        <div class="sign-up-modal-content" style="overflow: hidden;">
            ...
            <div class="sign-work-belt">
                ...
                <div class="signup-wrap" style="">
                    ...
                    {{--                    @if(isset($signup_using_affiliate) && $signup_using_affiliate=='YES')--}}
                    {{--<h3>SIGN UP </h3><br>--}}
                    {{--<p>USING AFFILIATE PROGRAM</p><br><br>--}}
                    {{--@else--}}
    ...
    <div class="forgotPassword-overlay">
        ...
        <div class="sign-up-modal-content" style="overflow: hidden;">
            ...
            <div class="sign-work-belt">
                ...
                {{--<form class="forgotPasswordModal" id="forgotPassword" style="height:180px;">--}}
                {{--<h3>--}}
                {{--Reset Password--}}
                {{--</h3>--}}

                {{--<div class="input-group">--}}
                {{--<p>Please enter your email address. We will send you password reset link to registered--}}
                {{--email.</p>--}}
                {{--</div>--}}
    ...
    <div class="modal-overlay" id="intro">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{--<iframe src="https://www.youtube.com/embed/FYkLBPVAvhs" autoplay="false"></iframe>--}}
                ...
                <div class="thumb-container">
                    ...
                    <div class="thumb-unit unit-1">
                        ...
                        {{--<div class='row'>--}}
                            ...
                            {{--<div style=" position: absolute; right:20px; bottom:20px;">--}}
                                {{--<a href="#" class="play-profile-video">--}}
                                    {{--<img src="/assets/user/images/play.png">--}}
                                {{--</a>--}}
                            {{--</div>--}}
                    ...
                    <div class="thumb-unit unit-2">
                        ...
                        {{--<div class='row'>--}}
                            {{--<div id="carousel-example-vertical2" class="carousel vertical slide text-center">--}}
                                {{--<div class="carousel-inner" role="listbox">--}}
                                    {{--<div class="item active">--}}
                                        ...
                                        {{--<ul>--}}
                                            {{--<li><strong>Smartffic will promote your profile 24/7 and expose it up to--}}
                            ...
                            {{--<ul>--}}
                            {{--<li> Smartffic will promote your profile 24/7 and expose it up to 15,000 people</li>--}}
                            {{--</ul>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                            {{--</blockquote>--}}
...
<script type="text/javascript">
    ...
    var signUpUsingAffiliate = '{{$signup_using_affiliate}}';
