...
<?php $__env->startSection('pagebodycontent'); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light">
                    ...
                    <?php /*<i class="fa fa-shopping-cart"></i>Users*/ ?>
                    <?php /*</div>*/ ?>
                    <?php /*</div>*/ ?>
    ...
    <?php /*<div class="modal fade" id="AccDetailsModal" role="dialog">*/ ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="profile-userpic">
                                            <img id="profile_image" src="" class="img-responsive img-circle"
                                                 alt="Loading.."
                                                 onerror="this.onerror=null;this.src='<?php echo e(env('WEB_URL')); ?>/assets/user/images/no_image.png'">
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="col-md-12">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php /*<button type="button" class="btn btn-info" data-dismiss="modal" id="close">OK</button>*/ ?>
                    </div>
