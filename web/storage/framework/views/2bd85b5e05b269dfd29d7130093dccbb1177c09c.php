    ...
    <div class="body">
        ...
        <div class="mobile-navbar">
            <?php if(!Session::has('instaffic_user')): ?>
            ...
            <?php else: ?>
                <ul class="navbar-list" >
                    ...
                    <li ><a href="/user/dashboard"><?php echo e(Session::get('instaffic_user')['email']); ?></a></li>
        ...
        <header>
            <nav class="navbar-menu" style="background: #4b097d">
                <div class="container">
                    ...
                    <?php else: ?>
                        <ul class="right-navbar-list" style="margin-bottom: 0;">
                            <li ><a href="/user/dashboard"  style="text-transform: none;"><?php echo e(Session::get('instaffic_user')['email']); ?></a></li>
                    ...
                    <?php endif; ?>
                    <?php /*<ul class="right-navbar-list" style="margin-bottom: 0;">*/ ?>
                        <?php /*<li><a  href='/' class="login pull-left" data-toggle="modal" data-target="#signin1" style="background: #fff; color:#4B097D;padding: 6px 15px 3px;border-radius: 3px; margin-right:5px;">Log in</a>*/ ?>
                            <?php /*<a class="pull-left" style="padding: 15px 0"> | </a>*/ ?>
                            <?php /*<a   href='/' class="login pull-left" data-toggle="modal" data-target="#signup" style="background: #fff; color:#4B097D;padding: 6px 15px 3px;border-radius: 3px;">Sign up</a></li>*/ ?>
                    <?php /*</ul>*/ ?>
                </div>
            </nav>
        ...
        <div id="system" class="alt-section section-service">
            <div class="col-md-12" style="padding: 0px 45px;">
                ...
                <div class="col-md-10 col-md-offset-1">
                        ...
                        of the terms and conditions sections, stop registering and using the Smartffic website.
                        Any sort of review or modification of the existing terms of use will be solely conducted
                        by Smartffic at any point of time. Your continued usage of the website will signify your
                        consent of acceptance to the revised terms.<br><br>

                        <h3><b>2. Services:</b></h3>

                    Smartffic is primarily used for the promotional purposes of your Instagram account and
                        posts. In order to perform such activities, Smartffic requires the official Instagram
                        account credentials. With complete access to your Instagram API, Smartffic will allow
                        ...
                        <p>Once you have added credits to Smartffic, it is not reversible till the system or the
                            ...
                            stop using the account- the time will not be adjusted or changes. And Smartffic will
                        ...
                        <p>In order to enjoy the services provided by Smartffic, it is necessary to provide your
                            credentials. On subscribing to a particular usage period of the services provided by
                            Smartffic, you are required to pay the total fee before discontinuing/canceling your
                        ...
                        <ul>
                            ...
                            <li>As Smartffic offers non-tangible irrevocable products, you agree that once a
                            ...
                            <li>You clearly understand and agree to the fact that once your payment via PayPal
                                is completed and your Smartffic account is being charged, you cannot file a
                            ...
                            <li>Smartffic will not be liable to process any cancel or order refund request for
                        ...
                        <p>Without any form prior written consent from an Smartffic representative, you are not
                        ...
                        <p>You agree that your usage of Smartffic is absolutely at your own risk and we will not
                            be held accountable for the damage/impairment it incurs to you/your business.</p>

                        <p>Smartffic doesn’t pledge website uptime or accessibility as it depends on the
                            internet to provide its services.</p>

                        <p>Smartffic is not liable for your account suspension or any discrepancies related to
                        ...
                        <p> These terms of service are subject to change at any time. Notices of even a minor
                            ...
                            website. No further notice by Smartffic is required upon your usage of our
                            website/software.
                        </p>
