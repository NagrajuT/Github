...
@section('pagebodycontent')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="javascript:;">Available Users</a>
                    <i class="fa fa-angle-right"></i>
                </li>
            </ul>
        </div>
    ...
    <div class="modal fade" id="UserDetailsModal" style="z-index: 999999 !important;" role="dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:#444D58;">
                    ...
                    <h4 class="modal-title" style="text-align:center; color:white;">
                        <i class="fa fa-user" aria-hidden="true"> </i> USER DETAILS</h4>
                </div>
                <div class="modal-body" id="user_info_data" style="padding:0px !important;">
