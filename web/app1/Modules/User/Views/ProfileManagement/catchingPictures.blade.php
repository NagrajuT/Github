                                                ...
                                                <div class="col-sm-12 col-md-6"
                                                    ...
                                                    <div class="in">
                                                        <span class="uppercase bold"
                                                              data-old_promotion_status="@if(isset($data['catchingPicturesDetails'])){{$data['catchingPicturesDetails']['promotion_status']}}@else{{0}}@endif"
                                                              id="promotion_change_status">

                                                            @if($data['catchingPicturesDetails']['promotion_status']==1)
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (parseInt(isDetailsPresent)) {
                post_count_per_day = '{{$data["catchingPicturesDetails"]["post_count_per_day"]}}';
                delay_between_post = '{{$data["catchingPicturesDetails"]["delay_between_post"]}}';
            ...
            var oldHashTagData = '{{old("hashTagData")}}' || '<?php if (isset($data["catchingPicturesDetails"]) && !empty($data["catchingPicturesDetails"]["tags"])) echo $data["catchingPicturesDetails"]["tags"];?>' || null;
            ...
            var oldUsernameData = '{{old("usernameData")}}' || '<?php if (isset($data["catchingPicturesDetails"]) && !empty($data["catchingPicturesDetails"]["usernames"])) echo $data["catchingPicturesDetails"]["usernames"];?>' || null;
            ...
            var oldLocationData = '{{old("locationData")}}' || '<?php if (isset($data["catchingPicturesDetails"]) && !empty($data["catchingPicturesDetails"]["locations"])) echo $data["catchingPicturesDetails"]["locations"]; ?>' || null;
            ...
            var catchingPicturesDataSavedStatus = "@if(isset($catchingPicturesDataSavedMsg)) {{$catchingPicturesDataSavedMsg['status']}} @endif" || null;
            if (catchingPicturesDataSavedStatus != null && catchingPicturesDataSavedStatus.trim().length > 0) {
                var catchingPicturesDataSavedMsg = "@if(isset($catchingPicturesDataSavedMsg)) {{$catchingPicturesDataSavedMsg['message']}} @endif";
