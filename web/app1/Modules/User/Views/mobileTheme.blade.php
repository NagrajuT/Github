...
<div class="body">
    ...
    <div id="system" class="alt-section section-service">
        <div class="text-center">
            ...
            <p>
                Instaffic Application is Currently Supported in all Android devices and coming soon for iPhone Devices.
            </p>
            <hr>
            <h2>Android</h2>
            <hr>
            ...
            <h2>iPhone</h2>
            <hr>
            <p>IPhone App for Instaffic will be Launched Soon.</p>
            <!--
