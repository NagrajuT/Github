                                    ...
                                    @if(isset($data['selectedUserDetails']) && $data['selectedUserDetails']['is_user_disconnected']!='Y')
                                        @if(isset($data['selectedUserDetails']) && $data['selectedUserDetails']['subscribe_type']=='BU')
                                                ...
                                                <div class="col-sm-12 col-md-6"
                                                    ...
                                                    <div class="in">
                                                        <span class="uppercase bold"
                                                              data-old_promotion_status="@if(isset($data['tagDetails'])){{$data['tagDetails']['promotion_status']}}@else{{0}}@endif"
                                                              id="promotion_change_status">

                                                            @if($data['tagDetails']['promotion_status']==1)
                                                ...
                                                <div class="col-sm-8 col-md-6">
                                                    ...
                                                    <div class="in">
                                                        ...
                                                        <input id="tagUserInNewPost" class="tagUserInNewPost"
                                                               ...
                                                               @if($data['tagDetails']['tag_post_type']=='NEW_POST') checked @endif >
                                                        ...
                                                        <input id="tagUserInSpecificPost" class="tagUserInSpecificPost"
                                                               value="TARGET_POST"
                                                               name="tagPostsType" type="radio"
                                                               @if($data['tagDetails']['tag_post_type']=='TARGET_POST') checked @endif >
                                            ...
                                            <div class="row" id="displayPosts"
                                                 @if($data['tagDetails']['tag_post_type']!='TARGET_POST') hidden @endif >
                                                <div class="col-md-3"></div>
                                        ...
                                        <span style="color:red"
                                              id="selectedMediaData_error">{{$errors->first('selectedMediaData')}}</span>
                                                </div>
                                                <br>
                                            </div>
                                                ...
                                                <div class="col-sm-8 col-md-6">
                                                    ...
                                                    <div class="in">
                                                        <input type="radio" id="tagMyFollowers" class="tag_users_type"
                                                               value="followers"
                                                               name="tagUsersType"
                                                               @if($data['tagDetails']['tag_users_type']=='followers') checked @endif />
                                                        <label for="tagMyFollowers"><span></span>Tag my new
                                                            followers</label><br>
                                                        <input type="radio" id="tagHashtagUsers" class="tag_users_type"
                                                               value="hashtags"
                                                               name="tagUsersType"
                                                               @if($data['tagDetails']['tag_users_type']=='hashtags') checked @endif />
                                                        ...
                                                        <input type="radio" id="tagLocationUsers" class="tag_users_type"
                                                               value="locations"
                                                               name="tagUsersType"
                                                               @if($data['tagDetails']['tag_users_type']=='locations') checked @endif />
                                            ...
                                            <div class="row" id="hashtagSearchEngine"
                                                 @if($data['tagDetails']['tag_users_type']!='hashtags') hidden @endif >
                                                <br><br>
                                                <div class="col-md-3"></div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row" id="locationSearchEngine"
                                                 @if($data['tagDetails']['tag_users_type']!='locations') hidden @endif>
                                                <br><br>
                                                <div class="col-md-3"></div>
                                                <div class="col-md-6">
...
@section('pagejavascripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            oldCheckedTagsUserType = "@if(isset($data['tagDetails'])){{$data['tagDetails']['tag_users_type']}}@endif" || "off";
            oldCheckedTagPostsType = "@if(isset($data['tagDetails'])){{$data['tagDetails']['tag_post_type']}}@endif" || "off";
...
//                        }
            ...
            var oldHashTagData = "{{old('hashTagData')}}" || "<?php if (isset($data['tagDetails']) && !empty($data['tagDetails']['tags'])) echo $data['tagDetails']['tags']; ?>" || null;
...
//                console.log(hashtags);
            ...
            var isDataExist = "@if( isset($data['tagDetails']) && !empty($data['tagDetails']['locations'] )) 1  @else 0 @endif";
            if (parseInt(isDataExist) === 1) {

                var oldLocationData = '@if( isset($data['tagDetails']) && !empty($data['tagDetails']['locations'] )) {{$data['tagDetails']['locations']}} @endif';
            ...
            var tagDataSavedStatus = "@if(isset($tagDataSavedMsg)) {{$tagDataSavedMsg['status']}} @endif " || null;

            if (tagDataSavedStatus != null && tagDataSavedStatus.trim().length > 0) {
                var tagDataSavedMsg = "@if(isset($tagDataSavedMsg)) {{$tagDataSavedMsg['message']}} @endif";
                var htmlModalData = '';
...
//                    $(currentElementObj).find('.tick').css('display', 'none');
            ...
            var isMediaDataExist = "@if(isset($data['tagDetails']) && (!empty($data['tagDetails']['tag_posts'])  || $data['tagDetails']['tag_posts']!=null ) ) 1  @else 0 @endif";
            if (parseInt(isMediaDataExist) == 1) {

                var viewMoreMediaDatahtml = '', viewMediaDatahtml = '';
                var oldTagPostsData = '@if( isset($data['tagDetails']) && !empty($data['tagDetails']['tag_posts'] )) {{$data['tagDetails']['tag_posts']}} @endif';
