    ...
    <div id="system" class="alt-section section-service">
        <div class="col-md-12" style="padding: 0px 10px 0px;">
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <p>Instaffic from global traffic is one of the only companies in the world that has development of automated system for  promotion, management  and an unprecedented possibility to make money in Instagram.</p>
                <p>Instaffic brings together a team of professionals in the field of marketing and systems development, with more than 7 years of experience in the field, with an emphasis on securing our customers' information and developing breakthrough and advanced ideas.</p>
                ...
                <p>Instaffic offers a wide range of tools and methods for marketing and advertising in the Instagram  , When everything runs  on our servers 24/7 Without having to be connected to the Internet or downloading any software.</p>
                <br>
                <h3><b><u>The concept behind Instaffic</u></b></h3>
                ...
                <p> A monthly  subscription to a system that creates massive exposure to your profile in Instagram - INSTAFFIC.</p>
                ...
                <p>All this is just a small part of a sweeping world we prepared for you ... INSTAFFIC.</p>
                <br>
                ...
                <p>We maintain a platform that connects advertisers and opinion leaders to register at INSTAFFIC.</p>
                <br>

                <h3><b><u>Affiliate Program</u></b></h3>
                <p>Needless to say how many hours of work, time, research, and resources have been invested in developing the INSTAFFIC system.</p>
                ...
                <p>Instaffic connects you with real accounts.</p>
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center; padding-top: 109px;">
                <a class="btn btn-success btn-lg btnblue" style="white-space: normal; " href="/?type=login"><img src="/assets/user/images/about_icon.png" width="35"> Come and try us with no obligation for 5 days free</a>
            </div>
            </div>
        </div>
    </div>
