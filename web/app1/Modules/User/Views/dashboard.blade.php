            ...
            <div class="row">
                ...
                <div class="portlet light pull-left" style="width:100%;">
                    <div class="portlet-title">
                        ...
                        {{--<a class="btn btn-success" href="/settingManagerIndex">--}}
                                        ...
                                        @if(isset($data) && !empty($data))
                                            <div class="row">
                                                @foreach($data as $key=>$value)
                                                    ...
                                                    <div class="insta_account col-md-6 col-sm-6 col-xs-12 col-lg-4 user_{{$key + 1}}" data-userId="{{$value['ins_user_id']}}">

                                                        @if($value['subscribe_type']== 'DU')
                                                            <div style="width: 100%; color:#fff; background: #50b948; padding: 10px;">
                                                                <h4 class="media-heading">{{$value['full_name']}}
                                                                    @if($value['is_user_disconnected']== 'Y')
                                                                        {{--<div data-toggle="tooltip"--}}
                                                                        {{--class="pull-right warn-hide"--}}
                                                                        {{--data-placement="top"--}}
                                                                        {{--title="Disconnected. Please connect it">--}}
                                                        ...
                                                        @elseif($value['subscribe_type']== 'BU')
                                                            <div class=""
                                                        ...
                                                        @elseif($value['subscribe_type']== 'PU')
                                                        ...
                                                        <div class=" media @if($value['subscribe_type']== 'DU') purple_border green_border green_lighbg
@elseif($value['subscribe_type']== 'PU') orange_border orange_lighbg @elseif($value['subscribe_type']== 'BU') purple_border purple_lighbg @endif  "
                                                             style="overflow: visible;">

                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-3 col-sm-12 text_center">
                                                                      <img class="media-object" style="height:50px; width:50px;" src="{{$value['profile_pic_url']}}"  alt="Image Not Found" onerror="this.src='/assets/user/images/no_image.png';">
                                                                    </div>
                                                                    <div class="col-md-8 col-sm-12 m-t-20 text_center padding0">
                                                                        <div class="media-body"
                                                                             style="overflow: visible;">
                                                                            <h5>
                                                                                <a href="http://www.instagram.com/{{$value['username']}}"
                                                                                   target="_blank">{{$value['username']}}</a>
                                                                                <br>
                                                                                <span class="social-side-intaffic">
                                                        @if($value['subscribe_type']=='PU') Private Subscriber
                                                                                    @elseif($value['subscribe_type']=='BU')
                                                                                        Bussiness Subscriber
                                                                                    @else  Demo Subscriber
                                                                                    @endif
                                                    </span>
                                                                            </h5>
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="row">
                                                                            <div class="mrgnbtm col-md-6 pull-left grey">Time
                                                                            </div>
                                                                            <div class="mrgnbtm text-right text_left col-md-6 pull-right">
                                                                    <span class="pull-right f12"
                                                                          id="time_period_left">{{$value['time_period_left']}}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                            ...
                                            <span class="grey" id="avtivity_status_label">
                                                @if($value['status']=='A') Started @else
                                                    Stopped @endif
                                            </span>
                                                                            </div>

                                                                            <div class="mrgnbtm text-right col-md-6 text_left pull-right">
                                            <span class="pull-right" id="avtivity_status_time" style="font-size:13px">@if($value['status']=='A') {{$value['start_date']}} @else {{$value['stop_date']}} @endif </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="row">
                                                                            <div class="mrgnbtm pull-left col-md-6 grey">Time
                                                                                Used
                                                                            </div>
                                                                            <div class="mrgnbtm text-right col-md-6 text_left pull-right">
                                                                    <span class="pull-right"
                                                                          id="used_time">{{$value['used_time']}}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <span class="pull-right"
                                                                        ...
                                                                        @if($value['current_promotion_status']==0)
                                                                            Stopped <i
                                                                    ...
                                                                    <div class="col-md-12 m-t-20 m_t_20">
                                                                       ...
                                                                       @if($value['status']=='I') Activate @else
                                                                                        Inactivate @endif
                                                                    </span>
                                                                       ...
                                                                       @if($value['status']=='I') Activate @else
                                                                        ...
                                                                        <div class="col-md-4 col-sm-4 m-t-10 btn-bg">
                                                                            @if($value['subscribe_type']== 'DU')
                                                                                <a href='/<?php echo(($value["current_promotion_type"] == 'F') ? "filter" : "default"); ?>/promotion/{{$value["ins_user_id"]}}'
                                                                                ...
                                                                                <ul class="nav"> <!--navbar-nav-->
                                                                                    ...
                                                                                    <li class="dropdown dropdown-user dropdown-dark dropup">
                                                                                        ...
                                                                                        <ul style="min-width:0px; margin-bottom:6px; margin-left:-15px"
                                                                                            ...
                                                                                            {{--<li><a href="#"> <i class="fa fa-trash-o"--}}
                                                                                            ...
                                                                                            <li id="changePromotionType"
                                                                                                data-userId="{{$value['ins_user_id']}}"
                                                                                                data-promotion_type="{{$value['current_promotion_type']}}"
                                                                                                data-promotion_status="{{$value['current_promotion_status']}}"
                                                                                                data-insta_account_div_id="{{$key + 1}}">
                                                                                                <a>
...
-->
    ...
    {{--aria-hidden="true">--}}
    {{--<div class="modal-dialog" style="margin-top: 125px; width: 32%;">--}}
    ...
    {{--<button type="button" class="btn btn-default" id="addInstagramAccount">Log In--}}
    {{--</button>--}}

    {{--<button type="button" class="btn btn-default hidden" id="closeModalBtn"--}}
    ...
    {{--<div class="modal fade" id="managePromotionType1" tabindex="-1" role="dialog"--}}
    {{--aria-labelledby="managePromotionTypeLabel"--}}
    {{--aria-hidden="true">--}}
    {{--<div class="modal-dialog" style="margin-top: 125px; width: 32%;">--}}
    {{--<div class="modal-content">--}}
    {{--<div class="modal-header modal-detail-header"--}}
    ...
    {{--<div class="col-md-12 col-sm-12" style="margin: 2px 0;">--}}
    {{--<div class="col-md-12">--}}
    {{--<div class="mrgnbtm pull-left grey">--}}
    {{--<label for="promotion_type"> Promotion Type</label>--}}

    {{--</div>--}}
    {{--<div class="mrgnbtm text-right pull-right">--}}
    {{--<span class="pull-right" id="current_promotion_type">--}}
    {{--<input id="promotion_type" checked data-toggle="toggle"--}}
    {{--data-on="FILTER"--}}
    {{--data-off="DEFAULT "--}}
    {{--data-size="mini" type="checkbox"--}}
    {{--data-width="100" data-height="6px">--}}
    {{--</span>--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    {{--<div class="mrgnbtm text-right pull-right">--}}
    {{--<span class="pull-right">--}}
    {{--<input id="promotion_status" checked data-toggle="toggle"--}}
    {{--data-on="START"--}}
    {{--data-off="STOP "--}}
    {{--data-size="mini" type="checkbox"--}}
    {{--data-width="100" data-height="6px">--}}
    ...
    {{--<button type="button" class="btn btn-default" id="savePromotionType">Save--}}
    {{--</button>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
...
@section('pagejavascripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            subscription_message = '@if(isset($subscription_message) && $subscription_message!=null) {{$subscription_message}} @endif';
