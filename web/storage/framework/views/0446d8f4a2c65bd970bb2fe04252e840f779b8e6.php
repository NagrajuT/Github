...
<?php $__env->startSection('headcontent'); ?>
    ...
    <?php /*<link rel="stylesheet" href="/assets/user/css/jRoll.css">*/ ?>
                        ...
                        <form>
                            <div class="input-group stylish-input-group">
                                <input type="text" class="form-control" id="searchInstagram" style="border-radius: 0px 2px !important;"
                                       placeholder=<?php if(isset($searchValue) && $searchValue!=null): ?> <?php echo e($searchValue); ?> <?php else: ?> "Search" <?php endif; ?>>
...
<?php $__env->startSection('pagejavascripts'); ?>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var value = '<?php echo e($searchValue); ?>';
