                                    ...
                                    <?php if(isset($data['selectedUserDetails']) && $data['selectedUserDetails']['is_user_disconnected']!='Y'): ?>
                                        <?php if(isset($data['selectedUserDetails']) && $data['selectedUserDetails']['subscribe_type']=='BU'): ?>
                                            ...
                                            <textarea rows="3" id="captionData" name="captionData"
                                                      class="form-control"><?php echo e(old('captionData')); ?></textarea>
...
<?php $__env->startSection('pagejavascripts'); ?>
    ...
    <?php /*<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdfxwAWQXGzVd4TfT83rILYzvgeoSIjQs&libraries=places&callback=initMap"></script>*/ ?>
    ...
    <script type="text/javascript">
        var hashtags = [], locations = [], usernames = [], timerid, instaUserId = '<?php if(isset($data['selectedUserId'])): ?><?php echo e($data['selectedUserId']); ?><?php endif; ?>';
