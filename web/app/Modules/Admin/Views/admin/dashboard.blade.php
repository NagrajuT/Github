            ...
            <div class="row">
                        ...
                        {{--<div class="display">--}}
                            {{--<div class="number">--}}
                                {{--<h3 class="font-green-sharp">--}}
                                    {{--<span class="counter" data-value="7800" data-counter="counterup">7800</span>--}}
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat blue-madison">
                        ...
                        <div class="details">
                            <div class="number counter" data-value="{{$data->usersCount}}" data-counter="counterup">
                                {{$data->usersCount}}
                            </div>
                            <div class="desc">
                                Total Users
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-haze">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value="{{$data->aCount}}" data-counter="counterup">
                                {{$data->aCount}}
                            </div>
                            <div class="desc">
                                Total Active Users
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red-intense">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value="{{$data->iCount}}" data-counter="counterup">
                                {{$data->iCount}}
                            </div>
                            <div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        ...
                        <div class="details">
                            <div class="number counter" data-value=" {{$data->pCount}}" data-counter="counterup">
                                {{$data->pCount}}
                            </div>
                            <div class="desc">
                                Total Pending Users
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-haze">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value=" {{$data->demoCount}}" data-counter="counterup">
                                {{$data->demoCount}}
                            </div>
                            <div class="desc">
                                Total Demo Users
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value="{{$data->paidCount}}" data-counter="counterup">
                                {{$data->paidCount}}
                            </div>
                            <div class="desc">
                                Total Paid users
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat blue-madison">
                        ...
                        <div class="details">
                            <div class="number counter" data-value="  {{$data->affiliateCount}}" data-counter="counterup">
                                {{$data->affiliateCount}}
                            </div>
                            <div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red-intense">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value="  {{$data->paidAffiliateCount}}" data-counter="counterup">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red-intense">
                        ...
                        <div class="details">
                            <div class="number counter" data-value="  {{$data->instagramUsersCount}}" data-counter="counterup">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-jungle">
                        ...
                        <div class="details">
                            <div class="number counter" data-value="  {{$data->duCount}}" data-counter="counterup">
                                {{$data->duCount}}
                            </div>
                            <div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat yellow-casablanca ">
                        ...
                        <div class="details">
                            ...
                            <div class="number counter" data-value="  {{$data->puCount}}" data-counter="counterup">
                                {{$data->puCount}}
                            </div>
                            <div class="desc">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum ">
                        ...
                        <div class="details">
                            <div class="number counter" data-value="  {{$data->buCount}}" data-counter="counterup">
                                {{$data->buCount}}
                            </div>
                            <div class="desc">
