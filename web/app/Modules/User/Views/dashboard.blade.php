                                    ...
                                    @if(isset($data) && !empty($data))
                                        <div class="row">
                                            @foreach($data as $key=>$value)
                                                ...
                                                <div class="insta_account col-md-6 col-sm-6 col-xs-12 col-lg-4 user_{{$key + 1}}"
                                                    ...
                                                    Stopped @endif
                                                                        ...
                                                                        <div class="mrgnbtm text-right col-md-6 text_left pull-right">
                                                                            <span class="pull-right"
                                                                                  ...
                                                                                  style="font-size:13px">@if($value['status']=='A') {{$value['start_date']}} @else {{$value['stop_date']}} @endif </span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
