...
<?php $__env->startSection('pageheadcontent'); ?>
    ...
    <?php /*<link rel="stylesheet" type="text/css" href="//cdn.datatables.net/1.10.10/css/jquery.dataTables.css">*/ ?>
...
<?php $__env->startSection('pagebodycontent'); ?>
    ...
    <div class="page-content">
        ...
        <!-- END PAGE HEADER-->
        <!-- BEGIN PAGE CONTENT-->
        <?php /*<button data-toggle="modal" id="addAllDetails" data-target="#addNews" class="btn btn-info">Add Proxy</button>*/ ?>
        <div class="row">
            <div class="col-md-12">
                <!-- Begin:  -->
                <div class="col-lg-12">
...
<?php $__env->startSection('pagescripts'); ?>
    ...
    <?php /*<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.10/js/jquery.dataTables.js"></script>*/ ?>
    <script src="/assets/admin/global/plugins/datatables/media/js/jquery.dataTables.min.js"></script>
    <?php /*<script src="https://cdnjs.cloudflare.com/ajax/libs/jstimezonedetect/1.0.4/jstz.min.js"></script>*/ ?>
    <script src="/assets/admin/js/jstz.min.js"></script>
    <?php /*<script src="/assets/admin/js/validate.min.js"></script>*/ ?>
    ...
    <?php /*<script  src="/public/assets/admin/js/jstz.min.js"></script>*/ ?>
    <script>
        //        $.validate({
        //            form: '#proxy_form'
        ////            modules : 'html5'
